...
Public Class frm_lista_empleados_usuarios
    ...
    Private Sub dgv_cliente_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_cliente.CellDoubleClick
        Try
            If e.RowIndex > -1 Then
                ...
                usuarios.txt_participante.Text = dgv_cliente.Rows(e.RowIndex).Cells(2).Value & " " & dgv_cliente.Rows(e.RowIndex).Cells(3).Value
