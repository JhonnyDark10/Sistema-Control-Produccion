...
Public Class usuarios
    ...
    Sub llenar_informacion()
        ...
        Try
            sql = ""
            sql = sql & "select usu_id,usu_per_id,usu_fk_empleados,usu_usuario as Usuario,usu_clave as Contraseña,emp_cedula as Cedula,emp_nombre as Nombre,emp_apellidoPaterno + ' '+emp_apellidoMaterno as Apellidos,per_Nombre as Perfil from seg_Usuarios u"
            sql = sql & " inner join Sis_Empleados p"
            sql = sql & " on u.usu_fk_empleados = p.emp_id "
            sql = sql & " inner join seg_perfil pe"
            sql = sql & " on pe.per_Id = u.usu_per_id "
            sql = sql & " where u.usu_estado = 'A' and p.emp_estado = 'A'"

            '   usu_id int IDENTITY(1,1) primary key NOT NULL,
            'usu_per_Id int NOT NULL,
            'usu_fk_empleados INT NOT NULL,
    ...
    Private Sub btn_escoger_Click(sender As Object, e As EventArgs) Handles btn_escoger.Click
        ...
        frm_lista_empleados_usuarios.ShowDialog()
    ...
    Private Sub btn_añadir_Click(sender As Object, e As EventArgs) Handles btn_añadir.Click
        ...
        Else
            Try
                sql = "INSERT INTO seg_usuarios(usu_per_id,usu_fk_empleados,usu_usuario,usu_clave,usu_estado) VALUES ("
    ...
    Private Sub btn_modificar_Click(sender As Object, e As EventArgs) Handles btn_modificar.Click
        ...
        Else
            Try
                sql = "UPDATE seg_usuarios SET usu_per_id =" & cbo_combo_perfiles.SelectedValue & ", usu_fk_empleados=" & txt_codigo.Text & ",usu_usuario = '" & txt_usuario.Text & "',usu_clave = '" & txt_contraseña.Text & "' WHERE usu_id= " & seg_usuario
                Dim com As New SqlCommand(sql, mycon)
                Dim x As Integer
                x = com.ExecuteNonQuery
